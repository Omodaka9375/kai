  ...
  return (
    ...
    >
      <button
        ...
        className="flex h-7 w-full items-center justify-between gap-2 whitespace-nowrap rounded-lg border border-border/60 bg-card/95 px-3 text-xs shadow-lg backdrop-blur-md hover:border-border hover:bg-accent"
      >
        <span>Ask Kai</span>
        <KbdGroup>
