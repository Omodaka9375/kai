...
export const MODELS = [
  ...
  },
  {
    ...
    label: "GLM 5.3",
    hint: "OpenRouter",
    description: "Zhipu's newest flagship — 1.3M context, stronger coding and reasoning than GLM 5.2.",
    capabilities: { intelligence: 5, speed: 4, cost: 5 },
    tags: ["reasoning", "tools", "coding"],
  },
  {
    ...
    label: "GLM 5.3 Flash",
    hint: "OpenRouter",
    description: "320B sparse-linear hybrid flagship at flash cost — native multimodal, 1.3M context.",
  ...
  },
  {
    ...
    hint: "OpenRouter",
    description: "High-speed Flash variant — up to 200 tok/s, native multimodal, 1M context.",
    capabilities: { intelligence: 4, speed: 5, cost: 5 },
    tags: ["vision", "reasoning", "tools", "coding"],
  },
  ...
  // ── Z.ai (GLM) ─────────────────────────────────────────────────────────────
  {
    ...
    label: "GLM 5.3",
    hint: "Flagship",
    description: "Latest flagship reasoning and coding model with 1M-token context.",
    capabilities: { intelligence: 5, speed: 4, cost: 5 },
    tags: ["reasoning", "tools", "coding"],
  },
  {
    ...
    label: "GLM 5.3 Flash",
    hint: "Fast",
    description: "Multimodal hybrid-attention flagship at flash cost, 1M context.",
    capabilities: { intelligence: 5, speed: 5, cost: 5 },
    tags: ["vision", "reasoning", "tools", "coding"],
  },
  {
    ...
    label: "GLM 5.3 FlashX",
    hint: "Turbo",
    description: "High-speed Flash variant — up to 200 tok/s, native multimodal.",
    capabilities: { intelligence: 4, speed: 5, cost: 5 },
    tags: ["vision", "reasoning", "tools", "coding"],
  },
  {
...
export const MODEL_PRICING: Record<string, ModelPricing> = {
  ...
  "z-ai/glm-5.3": { input: 0.91, output: 2.86, cacheRead: 0.169 },
  "z-ai/glm-5.3-flash": { input: 0.075, output: 0.25, cacheRead: 0.02 },
