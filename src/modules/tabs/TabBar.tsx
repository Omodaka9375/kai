            ...
            {tabs.map((t) => {
              ...
              return (
                <TabsTrigger
                  ...
                  className={cn(
                    "group h-7 shrink-0 gap-1.5 rounded-md border-0 shadow-none ring-0 text-xs text-muted-foreground transition-colors data-[state=active]:bg-accent data-[state=active]:text-foreground hover:text-foreground/80 justify-between",
                    compact
                      ? "px-1.5!"
                      : tabs.length === 1
                        ? "px-2!"
